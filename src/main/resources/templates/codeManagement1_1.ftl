    ...
    <div class="col-sm-10 col-sm-offset-1">
        <div class="container">
            <div class="btn-group">
                ...
                <button type="button" class="btn btn-default" data-toggle='modal' data-target='#codeTitleModal'>上传文件</button>
            ...
            <div class="btn-group" style="margin-left: 60px">
                <button type="button" class="btn btn-default">文件夹1.1</button>
                <button type="button" class="btn btn-default dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown">
                    代码文件列表
                    <span class="caret"></span>
                </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 100px">
                ...
                <button type="submit" class="btn btn-success col-xs-2" onclick="codeManagement2(${project.pid})">确认</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body" style="height: 100px">
                ...
                <button type="submit" class="btn btn-success col-xs-2" onclick="codeManagement1_2(${project.pid})">确认</button>
            </div>
        </div>
    </div>
</div>
